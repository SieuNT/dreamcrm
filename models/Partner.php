...
class Partner extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['notes'], 'string'],
            ['email', 'email'],
            [['contract_value', 'real_value'], 'safe'],
    ...
    public function getUsers() {
        return $this->hasMany(User::className(), ['id', 'user_id'])
            ->viaTable('user_partner', ['partner_id', 'id']);
    }
    ...
    {
//        $this->contract_value = Yii::$app->formatter->asDecimal($this->contract_value);
//        $this->real_value = Yii::$app->formatter->asDecimal($this->real_value);
